<?php
// Vulnerable PHP file for XSS testing
// This file intentionally contains multiple reflected XSS vulnerabilities
...
<body>
    <div class="container">
        ...
        <div class="vulnerable">
            ...
            <ul>
                <li><code>https://16.170.226.104/vulnerable.php?name=&lt;script&gt;alert('XSS')&lt;/script&gt;</code></li>
                <li><code>https://16.170.226.104/vulnerable.php?search=&lt;img src=x onerror=alert('XSS')&gt;</code></li>
                <li><code>https://16.170.226.104/vulnerable.php?q=&lt;svg onload=alert('XSS')&gt;</code></li>
                <li><code>https://16.170.226.104/vulnerable.php?name=test&search=&lt;script&gt;alert('XSS')&lt;/script&gt;</code></li>
            </ul>
        </div>

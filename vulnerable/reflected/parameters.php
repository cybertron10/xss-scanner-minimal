<?php
// Vulnerable PHP file for XSS testing - /vulnerable/reflected/parameters endpoint
...
<head>
    ...
    <title>Vulnerable XSS Test Page - Parameters Endpoint</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>🚨 Vulnerable XSS Test Page - Parameters Endpoint</h1>
        ...
        <div class="vulnerable">
            ...
            <ul>
                <li><code>https://16.170.226.104/vulnerable/reflected/parameters?name=&lt;script&gt;alert('XSS')&lt;/script&gt;</code></li>
                <li><code>https://16.170.226.104/vulnerable/reflected/parameters?search=&lt;img src=x onerror=alert('XSS')&gt;</code></li>
                <li><code>https://16.170.226.104/vulnerable/reflected/parameters?q=&lt;svg onload=alert('XSS')&gt;</code></li>
            </ul>
        </div>
